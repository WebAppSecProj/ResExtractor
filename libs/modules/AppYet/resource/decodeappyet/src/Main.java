...
public class Main {
    ...
    public static void main(String[] args){
        String plain = decrypt("/home/user/IdeaProjects/decodeappyet/metadata.txt");
    ...
    public static String decrypt(String file){
        ...
        initCipher("X5nFe16r7FbKpb16lJGH386S4WFaqy1khWWzo7Wyv3Pr1wJlF5C28g39kNcPYt4p2s3FayL3u28KfLxUQx8c922XH9inECtciY0hgsegn443gfeg543");
        try {
